        ...
        <div className='flex items-center gap-6'>
            ...
            <div className='group relative'>
                ...
                <div className='flex flex-col gap-2 w-36 py-3 px-5 bg-slate-100 text-gray-700 rounded'>
                    ...
                    <p className='cursor-pointer text-black'>Orders</p>
            ...
            <Link to='/cart' className='relative'> 
                ...
                <p className='absolute right-[-5px] bottom-[-5px] w-4 text-center text-white bg-black rounded-full text-[8px] leading-4 aspect-square'>10</p>
            </Link>
                <img onClick={()=> setVisible(true)} src={assets.menu_icon} className='w-5 sm:hidden' alt="" />
            </div>

            <div className={`sm:hidden absolute top-0 right-0 bottom-0 overflow-hidden bg-white transition-all ${visible?'w-full':'w-0'}`}>
